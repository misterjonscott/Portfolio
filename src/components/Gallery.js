...
import { GalleryGrid, GalleryContainer, GallerySection, GalleryContent, GalleryTextContainer, MyRole, GalleryGraphicContainer, GalleryGraphic, GallerySupportingGraphicContainer, ArrowIcon, arrowPath } from './GalleryStyles';

const slides = [
  {
    title: "UX for Student Engagement",
  ...
  {
    title: "Empowering Lab Developers",
  ...
  {
    title: "Building Better Labs Together",
  ...
  {
    title: "Optimizing the Experience",
  ...
  {
    title: "Simplifying Safe Local Shopping",
  ...
  {
    title: "From Feeds to Footprints",
    ...
    imageSrc: "./img/gallery/GeofeediaAlertsNew.png"
  },
  {
    title: "One-Stop Account Hub",
    ...
    role: "UI Developer / UX Designer",
    imageSrc: "./img/gallery/GeofeedaAccountsNew.png"
  },
  {
    title: "Evolving a Biotech Leader",
    ...
    imageSrc: "./img/gallery/IndigoRebrandNew.png"
  },
  {
    ...
    role: "UI Developer / UX Designer",
    imageSrc: "./img/gallery/LidsCustomTeamShops.png"
  }
];
  ...
  return (
    <GalleryContainer id="gallery">
      ...
      <GalleryGrid>
        ...
        <ArrowIcon onClick={nextSlide} style={{ transform: 'rotate(180deg)' }}>
          {arrowPath}
        </ArrowIcon>
      </GalleryGrid>
    </GalleryContainer>
