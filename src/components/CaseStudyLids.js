...
const CaseStudyLids = () => {
  return <div>
    <CaseStudyHeader>
      ...
      <div id="title">
        <h1>Streamlining the Shopping Experience</h1>
        ...
        <Tags>
          <Tag>UI Developer</Tag> <Tag>UX Designer</Tag>
        </Tags>
      </div>
    </CaseStudyHeader>
    <CaseStudyContainer>
      ...
      <section>
        ...
        <TwoColumn>
          <div>
            <h3>The Challenge</h3>
            <p>Lids' online checkout process was riddled with friction points, leading to cart abandonment. Confusing steps and unclear information frustrated users on the verge of purchase. Additionally, the shopping cart lacked features to entice customers nearing the free shipping threshold, and designing unique homepages for various Lids teams and organizations presented a challenge.  These homepages needed a shared codebase for efficiency, but also distinct visual identities to reflect each brand.</p>
          </div>
          <div>
            <h3>The Solution</h3>
            <p>We streamlined the checkout process, eliminating unnecessary steps and providing transparent information. This fostered a smoother user experience and reduced cart abandonment. The shopping cart was enhanced with features to nudge users towards the free shipping threshold, potentially including progress indicators and targeted product recommendations. To address the homepage challenge, we developed a design system that allowed for a shared codebase while enabling customization. This ensured a consistent user experience across all Lids brands while maintaining unique visual identities for each team or organization.</p>
          </div>
        </TwoColumn>
      </section>
      <section>
      ...
      <section>
        ...
        <p>Gone are the days of multi-page checkouts! We streamlined the process into a single, efficient page.  As users complete a section (e.g., Order Summary), a glimpse of the next section's first input field appears at the top, guiding them forward visually. To prevent errors, real-time form validation activates as users navigate between sections.  If an issue arises (e.g., missing billing information), the system highlights the error within the previously completed section, prompting the user to fix it before continuing.  For added convenience, completion cards for each stage (Order Summary, Billing Address, Shipping Address, Shipping Method, Payment Method) appear on the right side.  Users can easily click on a card to revisit and edit any section throughout the checkout process.  This redesigned single-page checkout reduces friction, improves clarity, and ultimately gets users to their purchase confirmation faster.</p>
        <GridContainer>
          <GridItem gridColumn="span 1" gridRow="1">
          ...
          <GridItem gridColumn="span 1" gridRow="2">
          ...
          <GridItem gridColumn="span 3" gridRow="2" /> {/* Empty cell for bottom row centering */}
        </GridContainer>
      </section>      
      <section>
        ...
        <TwoColumn>
          ...
          <div>
            <p>We transformed the shopping cart into a conversion powerhouse!  Utilizing a two-column approach, we streamlined the user experience while subtly encouraging purchases.  On the right side, a clear overview of the user's selections resides.  Here, they can effortlessly modify quantities, remove items, or even customize their products.  A timely prompt highlights the additional amount needed to reach the free shipping threshold, enticing them to explore and potentially add more items.</p>

            <p>For added convenience, a row of action buttons - "Continue Shopping" and "Secure Checkout" - appears prominently at the top and bottom of the cart.  This allows users to effortlessly navigate based on their needs.  Detailed breakdowns of each charge - subtotal, promo code input, shipping options, estimated tax, and estimated total - provide complete transparency throughout the checkout journey.</p>

            <p>To further incentivize purchases, a banner showcasing hot products flanks the bottom of the cart.  Finally, three secure checkout processing icons subtly reinforce trust and build confidence as users proceed to finalize their orders.  This redesigned shopping cart offers a clear, feature-rich experience that empowers informed decisions and ultimately drives conversions.</p>
          </div>
        </TwoColumn>
      </section>
      <section>
      ...
      <section>
        ...
        <ThreeColumnBlocks>
          ...
          <div className='block'>
            ...
            <p>Developing a cohesive design system proved instrumental in streamlining the development of unique homepages for various Lids teams and organizations. This system offered a shared codebase, enabling rapid development while still allowing customization through pre-built components and two width options. This approach ensured a consistent user experience across all Lids brands, while empowering each team to express their distinct visual identity.</p>
          </div>
          <div className='block'>
            <div className='title'>
