...
const jobsData = [
  {
    ...
    companyInfo: {
      ...
      dateRange: "July 2023 - current, (Fully Remote)"
    },
    positionDescription: [
  ...
  {
    positionTitle: "Senior UI Engineer / UI Designer (hybrid)",
    companyInfo: {
  ...
  {
    positionTitle: "UI Developer / UX Designer (Hybrid)",
    companyInfo: {
